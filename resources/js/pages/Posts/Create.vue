...
const platforms = props.platforms.data
                        ...
                        <li v-for="platform in platforms" :key="platform.id"
                            ...
                            <div class="flex flex-col items-center">
                                <label :for="'platform-checkbox-' + platform.id"
                                    ...
                                    <i v-html="platform.icon" class="mr-2 px-5 rounded-full border flex items-center h-15 w-15 justify-center text-center"></i>
                                    {{ platform.name }}
                                </label>
